            ...
            <div className="flex min-h-dvh flex-col bg-gray-100 pb-24">
                ...
                <div className="mx-auto w-full max-w-2xl flex-1 px-0 md:px-4 md:py-4">
                    ...
                    <div className="mt-2 bg-white px-4 py-4">
                        ...
                        {/* Title */}
                        <h1 className="mt-1.5 text-base font-semibold leading-snug text-gray-800">
                            {searchedProduct.title}
                        </h1>
                        <div className="mt-3 flex items-center">
                            <span className="rounded-md bg-orange-50 px-2.5 py-1 text-xs font-medium text-orange-600 border border-orange-100">
